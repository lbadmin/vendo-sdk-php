...
use VendoSdk\S2S\Request\Details\Pix;
...
class PixPaymentTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $payment = self::createPartialMock(\VendoSdk\S2S\Request\Payment::class, ['getHttpRequest']);
