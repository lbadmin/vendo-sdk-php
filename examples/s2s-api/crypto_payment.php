...
try {
    ...
    $payment->setApiSecret(getenv('SECRET_API'));//replace getenv(... with your_secret_api_secret
    $payment->setMerchantId(getenv('MERCHANT_ID'));//Your Vendo Merchant ID

    $payment->setSiteId(getenv('SITE_ID'));//Your Vendo Site ID
