<?php
/**
 * This example shows you how to run a payment method registration PreAuthorization.
 */
...
try {
    ...
    $verificationDetails->setVerificationId(240327150);//use verification_id returned in change-subscription-payment-details-request
    $registerPaymentMethod->setPaymentDetails($verificationDetails);
    /**
     * Customer details
     */
