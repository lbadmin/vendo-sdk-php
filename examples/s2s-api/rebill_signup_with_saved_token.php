...
try {
    ...
    $tokenPayment->setCurrency(\VendoSdk\Vendo::CURRENCY_EUR);
    ...
    $tokenPayment->setIsMerchantInitiatedTransaction(true);
    ...
    $token->setToken('5acd86ecc7ba3150a6095a7fa64bd666');//this is a dummy example, get it from your database or use a token from a previous test
    ...
    $tokenPayment->setSubscriptionSchedule($schedule);
    /**
